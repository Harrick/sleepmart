...
if ( ! function_exists( 'zn_wrap_images' ) ) {
    ...
    <img(.*?)class =('|\")(.*?)(.*?)(alignleft|alignright|aligncenter|alignnone)(.*?)('|\")(.*?)>
        /i";
        $replacement = '<a$1href =$2$3.$4$5 class="hoverBorder $11" $6>
            <img class="$10$12" $14>';
            ...
            <style type='text/css'>
                ...
                ; margin-top: 10px; text-align: center; width: {
                    $itemwidth;
                }
...
';
            ...
            <li
                ...
                <div id="comment-<?php comment_ID(); ?>">
                    ...
                    <div class="comment-meta commentmetadata">
                        <a href="<?php echo htmlspecialchars(get_comment_link( $comment->comment_ID )) ?>">
                            <?php printf(__('%1$s at %2$s',THEMENAME), get_comment_date(),get_comment_time()) ?>
                        </a><?php edit_comment_link(__('(Edit)',THEMENAME),'  ','') ?>
                    </div>
                ...
                echo "<div class='pagination'>
                    ...
                    echo '<ul>
                        ...
                        if(1 == $paged) {
                        echo '
                        <li class="pagination-start"><span class="pagenav">'.__( 'Start', THEMENAME ).'</span></li>';
                        echo '
                        <li class="pagination-prev"><span class="pagenav">'.__( 'Prev', THEMENAME ).'</span></li>';
                        }
                        else {
                        echo '
                        <li class="pagination-start"><a href="'.get_pagenum_link(1).'">'.__( 'Start', THEMENAME ).'</a></li>';
                        echo '
                        <li class="pagination-prev"><a href="'.get_pagenum_link($paged-1).'">'.__( 'Prev', THEMENAME ).'</a></li>';
                        }
                        ...
                        if($paged < $pages ) {
                        echo '
                        <li class="pagination-next"><a href="'.get_pagenum_link($paged+1).'">'.__( 'Next', THEMENAME ).'</a></li>';
                        echo '
                        <li class="pagination-end"><a href="'.get_pagenum_link($pages).'">'.__( 'End', THEMENAME ).'</a></li>';
                        }
                        else {
                        echo '
                        <li class="pagination-next"><span class="pagenav">'.__( 'Next', THEMENAME ).'</span></li>';
                        echo '
                        <li class="pagination-end"><span class="pagenav">'.__( 'End', THEMENAME ).'</span></li>';
                        }
                ...
                $before = '<span class="current">
                    ...
                    $after = '
                </span>'; // tag after the current crumb
                ...
                $prepend =  '
            <li typeof="v:Breadcrumb"><a rel="v:url" property="v:title" href="' . get_permalink( woocommerce_get_page_id('shop') ) . '">' . get_the_title( woocommerce_get_page_id('shop') ) . '</a></li>';
            ...
            echo '<ul xmlns:v="http://rdf.data-vocabulary.org/#" class="breadcrumbs fixclear">
                <li typeof="v:Breadcrumb"><a rel="v:url" property="v:title" href="' . $homeLink . '">' . $home . '</a></li>';
                ...
                if ( !empty ( $s_cat ) ) {
                $s_cat = str_replace ( '
                <a', '<a rel="v:url" property="v:title" ' , $s_cat );
                     echo '<li typeof="v:Breadcrumb">' .$s_cat.'
                    </li>';
                    }
                    }
            ...
            $output = preg_match_all( '/<img.+src =[\'"]([^\'"]+)[\'"].*>
                ...
                *
                ...
                echo '<ul class="social-icons '.$icon_class.' topnav navRight">
                    ...
                    echo '
                    <li class="'.$icon['header_social_icon'].'"><a href="'.$link.'" '.$target.'>'.$icon['header_social_title'].'</a></li>';
                    }
                        ...
                        <div class="pPanel">
                            <div class="inner">
                                <span class="cart_details">
                                    <?php echo sprintf(_n('%d item', '%d items', $woocommerce->cart->cart_contents_count,THEMENAME), $woocommerce->cart->cart_contents_count);?>, <?php _e("Total of",THEMENAME);?> <?php echo $woocommerce->cart->get_cart_total(); ?> <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart',THEMENAME); ?>" class="checkout">
                                        <?php _e("Checkout",THEMENAME);?> <span class="icon-chevron-right"></span>
                                    </a>
                                </span>
                            </div>
                        </div>
                ...
                echo '<ul class="topnav navLeft">
                    ...
                    <li class="languages drop">
                        <a href="#"><span class="icon-globe icon-white"></span> '.__("LANGUAGES",THEMENAME).'</a>';
                    ...
                    <li class="'.$active.'">
                        <a href="'.$l['url'].'">
                            '.$l['native_name'].' <img src="'.$l['country_flag_url'].'" alt="'.$l['native_name'].'" /> '.$icon.'';
